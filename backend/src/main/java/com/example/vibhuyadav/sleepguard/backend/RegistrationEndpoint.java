 ...
 */
@Api(name = "registration", version = "v1", namespace = @ApiNamespace(ownerDomain = "backend.sleepguard.vibhuyadav.example.com", ownerName = "backend.sleepguard.vibhuyadav.example.com", packagePath = ""))
